...
export function renderBatteryBarItem(
    item: any,
    index: number,
    isExpanded: boolean,
    hass: any,
        ...
        <div class="consumer-section">
            ...
            <div class="consumer-content ${isExpanded ? '' : 'collapsed'}">
                ...
                ${renderNumberfield(
                    ...
                    { min: 0, max: 100000, step: 100, helper: t.editor.battery_capacity_helper }
                )}
                ${renderEntityPicker(
                    ...
                    { helper: t.editor.charge_entity_helper, translations: { editor: t.editor } }
                )}
                ${renderEntityPicker(
                    ...
                    { helper: t.editor.discharge_entity_helper, translations: { editor: t.editor } }
                )}
                ${renderIconPicker(
                    t.editor.icon_label,
                    item.icon,
